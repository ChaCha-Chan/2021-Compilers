...
Program : PROGRAMnum ID SEMInum __ClassDecl
        { $$ = MakeTree(ProgramOp, $4, MakeLeaf(IDNode, $2)); parseTree = $$; /*printtree($$, 0);*/}
        ;
...
SimpleExpression : Term
        ...
        { $$ = MkLeftC(MakeTree(UnaryNegOp, NullExp(), $2), $3); }
        ;
...
main() {
    ...
    string_table = (string_item*)malloc(TABLE_MAX_SIZE * sizeof(string_item));
